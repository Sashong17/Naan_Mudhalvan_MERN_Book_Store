...
const Signup = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-900">
      <div className="relative max-w-md w-full bg-white p-10 rounded-lg shadow-xl overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <p className="text-center text-sm text-gray-600 mt-4">
              ...
              <button
                onClick={formHandle1}
                className="text-yellow-500 font-medium hover:underline focus:outline-none"
              >
                Login
              </button>
            </p>
